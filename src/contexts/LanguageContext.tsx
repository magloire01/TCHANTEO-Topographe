...
const translations = {
  fr: {
    ...
    "nav.contact": "Contact",
    "hero.title": "Géomètre-Topographe",
    "hero.subtitle": "Professionnel",
    "hero.description": "Expertise technique et précision au service de vos projets d'aménagement, construction et délimitation foncière.",
